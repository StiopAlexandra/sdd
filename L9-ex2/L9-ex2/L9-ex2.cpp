/*Determinaţi suma gradelor tuturor vîrfurilor unui graf neorientat şi comparaţi-o
cu numărul de muchii a acestuia. Ce observaţi?  */
...
void main() {
	...
	fclose(f);
	AfisImplGraf();
	cout << "\nSuma gradelor varfurilor este " << nr;
	cout << "\nIn total sunt "<<n<<" muchii";
	cout << "\nSuma gradelor varfurilor este de doua ori numarul de muchii";
}
